...
#include "CBridge.h"
#define OCELOT_TYPES {}
#define EXECUTE_OCELOT_TEST int __arg0 = OCELOT_NUM(OCELOT_ARGUMENT_VALUE(0));\
int __arg1 = OCELOT_NUM(OCELOT_ARGUMENT_VALUE(1));\
int __arg2 = OCELOT_NUM(OCELOT_ARGUMENT_VALUE(2));\
int __arg3 = OCELOT_NUM(OCELOT_ARGUMENT_VALUE(3));\
int __arg4 = OCELOT_NUM(OCELOT_ARGUMENT_VALUE(4));\
int __arg5 = OCELOT_NUM(OCELOT_ARGUMENT_VALUE(5));\
int __arg6 = OCELOT_NUM(OCELOT_ARGUMENT_VALUE(6));\
int __arg7 = OCELOT_NUM(OCELOT_ARGUMENT_VALUE(7));\
int __arg8 = OCELOT_NUM(OCELOT_ARGUMENT_VALUE(8));\
int __arg9 = OCELOT_NUM(OCELOT_ARGUMENT_VALUE(9));\
OCELOT_TESTFUNCTION (__arg0,__arg1,__arg2,__arg3,__arg4,__arg5,__arg6,__arg7,__arg8,__arg9);
