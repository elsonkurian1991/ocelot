...
/**
 * This class implements a polynomial mutation operator. It differs from 
 * PolynomialMutationParams in that it works on GenericSolutions.
 */
public class GenericPolynomialMutationParams extends Mutation {
	/**
	 * 
	 */
	 ...
	 */
	public GenericPolynomialMutationParams(HashMap<String, Object> parameters) {
		super(parameters);
	...
	public Object execute(Object object) throws JMException {
		...
		if (!VALID_TYPES.contains(solution.getType().getClass())) {
			Configuration.logger_
					.severe("GenericPolynomialMutation.execute: the solution "
