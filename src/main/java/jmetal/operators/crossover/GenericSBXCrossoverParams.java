 ...
 * solutions. It differs from SBXCrossoverParams in that it works on 
 * GenericSolutions.
 */
@SuppressWarnings("serial")
public class GenericSBXCrossoverParams extends Crossover {
	/**
	 ...
	 */
	public GenericSBXCrossoverParams(HashMap<String, Object> parameters) {
		super(parameters);
	...
	public GenericSolution[] doCrossover(double probability, GenericSolution parent1,
		...
		GenericSolution[] offSpring = new GenericSolution[2];

		offSpring[0] = new GenericSolution(parent1);
		offSpring[1] = new GenericSolution(parent2);
		...
		XParam x1 = new XParam(parent1);
		XParam x2 = new XParam(parent2);
		XParam offs1 = new XParam(offSpring[0]);
		XParam offs2 = new XParam(offSpring[1]);
	...
	public Object execute(Object object) throws JMException {
		...
		if (!(VALID_TYPES.contains(parents[0].getType().getClass()) && VALID_TYPES
			...
			Configuration.logger_.severe("GenericSBXCrossover.execute: the solutions "
