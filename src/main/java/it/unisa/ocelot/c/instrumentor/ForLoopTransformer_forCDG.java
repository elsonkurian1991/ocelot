...
public class ForLoopTransformer_forCDG extends ASTVisitor {
	...
	public ForLoopTransformer_forCDG(IASTTranslationUnit tu) {
	...
	public int visit(IASTStatement statement) {
		if (statement instanceof IASTForStatement) {
			...
			if (grandParent instanceof IASTStatement) {
				...
				IASTFunctionDefinition funcDef = (IASTFunctionDefinition) grandParent;
				funcDef.setBody(newCompound);
				System.err.println(grandParent.getRawSignature());
			} else {
				System.err.println("Unsupported parent node: " + grandParent.getClass().getSimpleName());
			}
			loopCounter++;
			System.out.println(grandParent.getRawSignature());
		}
